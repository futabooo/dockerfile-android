...
RUN \
  ...
  echo y | /opt/android-sdk-linux/tools/android update sdk --no-ui --all --filter platform-tools,build-tools-23.0.2,build-tools-23.0.3,build-tools-24.0.0,android-23,android-24 && \
